...
const animationVariants: Record<AnimationStyle, {
...
export function HeroVideoDialog({
  ...
  const renderAsFileVideo = isFileVideo(videoSrc);
            ...
            <div className="relative isolate z-[1] size-full overflow-hidden rounded-2xl border-2 border-white">
              {renderAsFileVideo ? (
                <video
                  ...
                  className="mt-0 size-full rounded-2xl bg-black"
                  controls
                  autoPlay
                  playsInline
                />
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      {isMounted && typeof document !== "undefined" ? createPortal(overlay, document.body) : null}
    </div>
  );
}
